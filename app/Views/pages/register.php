...
<!-- Mirrored from arasari.studio/wp-content/projects/forny/templates/05_register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Mar 2022 08:06:19 GMT -->
<!-- Added by HTTrack -->
...
<body>
                        ...
                        <form>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input required class="form-control" id="firstname" name="fisrtname" type="text" placeholder="Fistname">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input required class="form-control" id="lastname" name="lastname" type="text" placeholder="Lastname">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="16" viewBox="0 0 24 16">
                                                <g transform="translate(0)">
                                                    <path d="M23.983,101.792a1.3,1.3,0,0,0-1.229-1.347h0l-21.525.032a1.169,1.169,0,0,0-.869.4,1.41,1.41,0,0,0-.359.954L.017,115.1a1.408,1.408,0,0,0,.361.953,1.169,1.169,0,0,0,.868.394h0l21.525-.032A1.3,1.3,0,0,0,24,115.062Zm-2.58,0L12,108.967,2.58,101.824Zm-5.427,8.525,5.577,4.745-19.124.029,5.611-4.774a.719.719,0,0,0,.109-.946.579.579,0,0,0-.862-.12L1.245,114.4,1.23,102.44l10.422,7.9a.57.57,0,0,0,.7,0l10.4-7.934.016,11.986-6.04-5.139a.579.579,0,0,0-.862.12A.719.719,0,0,0,15.977,110.321Z" transform="translate(0 -100.445)" />
                                                    <!-- <path d="M493.4 24.6l-104-24c-11.3-2.6-22.9 3.3-27.5 13.9l-48 112c-4.2 9.8-1.4 21.3 6.9 28l60.6 49.6c-36 76.7-98.9 140.5-177.2 177.2l-49.6-60.6c-6.8-8.3-18.2-11.1-28-6.9l-112 48C3.9 366.5-2 378.1.6 389.4l24 104C27.1 504.2 36.7 512 48 512c256.1 0 464-207.5 464-464 0-11.2-7.7-20.9-18.6-23.4z" transform="translate(0 -100.445)"></path> -->
                                                </g>
                                            </svg>
                                        </span>
                                    </div>
                                    <input required class="form-control" id="phone" name="phone" id="phone" type="phone" placeholder="Phone">
                                </div>
                            </div>
                            <div class="form-group password-field">
                                <div class="input-group">
                                    ...
                                    <input required class="form-control" id="pass1" name="password" type="password" placeholder="Password">
                            ...
                            <div class="form-group password-field">
                                <div class="input-group">
                                    ...
                                    <input required class="form-control" id="pass2" name="pass2" type="password" placeholder="Confirm Password">
                                    <div class="input-group-append cursor-pointer">
                                        <span class="input-group-text">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="16" viewBox="0 0 24 16">
                                                <g transform="translate(0 0)">
                            ...
                            <div>
                                <button class="btn btn-primary btn-block" id="regesterbtn" onclick="register(); return false">Register</button>
                            </div>
    ...
    <script src="/assets/js/customJS/auth/register.js"></script>
</body>

<!-- Mirrored from arasari.studio/wp-content/projects/forny/templates/05_register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Mar 2022 08:06:21 GMT -->
