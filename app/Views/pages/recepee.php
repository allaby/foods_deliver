...
<section id="or-blog-feed" class="or-blog-feed-section">
    <div class="container">
        ...
        <div class="or-section-title headline pera-content text-center middle-align">
            <span class="sub-title">Nos recettes</span>
            <h2>On a quest to bring together and closer
                to you all things Organic.</h2>
        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="or-blog-innerbox">
                        ...
                        <div class="or-blog-text headline position-relative">
                            ...
                            <h3><a href="blog-single.html">Finding a way to separate
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="or-blog-innerbox">
                        ...
                        <div class="or-blog-text headline position-relative">
                            ...
                            <h3><a href="blog-single.html">Hunching over desk can
                                    cause pain.</a></h3>
                            <div class="blog-more-comment d-flex justify-content-between">
                                <a class="read-more" href="blog-single.html">Read more <i class="far fa-chevron-right"></i></a>
                                <a class="commnet" href="#"><i class="fas fa-comment"></i>04</a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="or-blog-innerbox">
                        ...
                        <div class="or-blog-text headline position-relative">
                            ...
                            <h3><a href="blog-single.html">We advocate swapping
